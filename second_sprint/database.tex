...
\begin{itemize}
  ...
  \item[\textbf{Orders:}] Used to represent the shopping basket before an
    ...
    been paid but not yet processed and shipped 
    (\mintinline{python}{payment==True and status==False}), 
    as well as finished Orders (\mintinline{python}{status == True}). Each
    Order has one User.
